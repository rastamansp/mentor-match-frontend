                    ...
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
                      ...
                      <div className="flex items-start space-x-4 flex-1">
                        ...
                        <div className="flex-1 min-w-0">
                          <h3 className="font-semibold text-lg mb-1">{session.mentor.name}</h3>
                          <p className="text-sm text-muted-foreground mb-1">{session.mentor.role}</p>
                          <p className="text-sm text-primary font-medium mb-3">{session.mentor.company}</p>
