...
export const RegisterWithRoleSchema = z.object({
  ...
  whatsappNumber: z.string().min(10, 'WhatsApp deve ter no mínimo 10 dígitos').max(11, 'WhatsApp deve ter no máximo 11 dígitos').regex(/^\d+$/, 'WhatsApp deve conter apenas números'),
});
